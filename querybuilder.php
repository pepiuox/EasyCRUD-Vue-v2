...
<body>
    ...
    if ($w == "select") {
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 id="fttl">Formulario</h3>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label" for="selecttb">Seleccionar Tabla</label> <select
...
<!-- Form Name -->
<legend>Agregar tabla para el generador de consultas</legend>

<!-- Button -->
<div class="form-group">
  <label class="col-md-4 control-label" for="addtable"></label>
  <div class="col-md-4">
    <button id="addtable" name="addtable" class="btn btn-info" href="http://' . $host . $uri . $redir . '">Agregar Tabla</button>
  </div>
</div>
        ...
        ?>
        <div class="container">
            <h2 class="text-primary">Agregar consulta para columna</h2>
            ...
            while ($finfo = $qresult->fetch_assoc()) {
                ...
                echo '<div class="form-group">
                            <label class="col-md-4 control-label" for="type">Elige tipo de entrada para ' . ucfirst($remp) . '</label>
                            <div class="col-md-4">
...
<option value="4" ';
                ...
                echo '<div class="form-group">
                          ...
                          Agregar Columna Id y Valor 
                          </button>
                          </div>' . "\n";

                echo '<div class="form-group" id="text_' . $finfo['tque_Id'] . '">
                            <label for="' . $finfo['col_name'] . '">Consulta para ' . ucfirst($remp) . ':</label>
            ...
            function tnmes() {
                ...
                echo '<div class="form-group" id="vtble">
                            <label class="control-label" for="table">Seleccione Tabla</label>
                            <div class="col-md-12">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="ModalLabel">Seleccione una columna para relacionar</h5>
        ...
        <div class="form-group" id="vtble">
            <label class="control-label" for="joins">Seleccionar tipo JOIN</label>
            <div class="col-md-12">
                <select id="joins" name="joins" class="form-control">
                    <option value="">Elegir JOIN</option>
